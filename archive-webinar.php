<?php
/**
 * Webinar Archive Template
 *
 * Template for displaying the webinar archive page.
 *
 * @package Onwords
 */
...
<div class="breadcrumb">
	<div class="breadcrumb__container">
		...
		<span class="breadcrumb__current">ウェビナー情報</span>
	</div>
</div>
	...
	<div class="archive-filter">
		<div class="archive-filter__container">
			<nav class="archive-filter__nav">
				...
				<a href="<?php echo get_term_link('private-company', 'knowledge_tag'); ?>"
				   class="archive-filter__button <?php echo ($is_tag_archive && $current_tag->slug === 'private-company') ? 'archive-filter__button--active' : ''; ?>">
					民間企業様向け
				</a>
				<a href="<?php echo get_term_link('local-government', 'knowledge_tag'); ?>"
				   class="archive-filter__button <?php echo ($is_tag_archive && $current_tag->slug === 'local-government') ? 'archive-filter__button--active' : ''; ?>">
					自治体・DMO様向け
				</a>
			</nav>
		</div>
